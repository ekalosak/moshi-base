...
class CurricV(Vocab, FB):
    """ Represents a vocabulary term in the curriculum. Holds the most information about a term. This is the reference material for sessions. See /curric/vocab/<bcp47>/<term> doc.   """
    ...
    level: int = Field(help="The level of the term in the curriculum.", default=None)